package no.spk.premie.tidsperiode.underlag.reglar;

import java.time.LocalDate;
import java.util.Optional;

import no.spk.premie.tidsperiode.AbstractTidsperiode;
import no.spk.premie.tidsperiode.underlag.Annoterbar;
import no.spk.premie.tidsperiode.underlag.BeregningsRegel;
 ...
 * </p>
 * Vi har to beregningsregler for å håndtere dette: {@code MinstegrenseRegelVersjon1} og {@code MinstegrenseRegelVersjon2}:
 * <pre>
