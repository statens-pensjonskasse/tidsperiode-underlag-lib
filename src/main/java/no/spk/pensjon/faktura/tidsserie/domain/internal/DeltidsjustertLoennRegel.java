 ...
 * <br>
 * Deltidsjustert lønn blir beregna på ein av to mulig måtar:
 * <ol>
 * <li>Dersom underlagsperioda er annotert med lønnstrinn, blir lønnstrinnet slått opp og konvertert til lønn i 100% stilling, for deretter å blir deltidsjustert ut frå periodas stillingsprosent</li>
 * <li>Dersom underlagsperioda ikkje er annotert med lønnstrinn, blir deltidsjustert lønn slått opp direkte frå periodas annotasjonar</li>
 * <li>Dersom perioda ikkje er annotert med verken lønnstrinn eller deltidsjustert lønn, feilar beregninga</li>
 * </ol>
 *
 * @author Tarjei Skorgenes
 */
public class DeltidsjustertLoennRegel implements BeregningsRegel<DeltidsjustertLoenn> {
    /**
     * Beregnar den deltidsjusterte årslønna som er gjeldande innanfor underlagsperioda.
     * <br>
     * Lønna blir enten beregna ut frå kombinasjonen av gjeldande lønnstrinnbeløp for periodas annoterte lønnstrinn, justert i henhold til stillingsprosent, eller
     * direkte basert på periodas annoterte deltidsjusterte lønn.
     *
     ...
     */
    @Override
    public DeltidsjustertLoenn beregn(final Underlagsperiode periode) throws PaakrevdAnnotasjonManglarException {
        ...
        return periode.annotasjonFor(DeltidsjustertLoenn.class);
    }
}
