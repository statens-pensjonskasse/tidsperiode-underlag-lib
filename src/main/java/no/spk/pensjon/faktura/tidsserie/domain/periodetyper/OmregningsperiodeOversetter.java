...
import static no.spk.pensjon.faktura.tidsserie.domain.periodetyper.Feilmeldingar.ugyldigAntallKolonnerForOmregningsperiode;

/**
 * {@link OmregningsperiodeOversetter} representerer algoritma
 * for å mappe om og konvertere omregningsperioder til
 * {@link Omregningsperiode}
 * <p>
...
public class OmregningsperiodeOversetter {
    ...
    /**
     * Oversetter innholdet i <code>rad</code> til ei ny {@link Omregningsperiode}.
     *
